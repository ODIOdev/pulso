        ...
        <article className="card p-6 md:p-10 mt-6 max-w-4xl">
          ...
          <div className="mt-7 grid gap-7 leading-7 text-neutral-700">
            ...
            <section>
              ...
              <p className="mt-2">
                El directorio de{" "}
                <Link href="/elecciones/2028" className="font-bold text-neutral-950 underline">
                  posibles candidatos 2028
                </Link>{" "}
                es solo informativo. Cualquier módulo de intención de voto, ranking electoral, propaganda o datos de
